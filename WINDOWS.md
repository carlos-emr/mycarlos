...
1. Sign in to GitHub and open the [Windows evaluation builds](https://github.com/carlos-emr/mycarlos/actions/workflows/mycarlos.yml?query=branch%3Afeat%2Finitial-tauri-vault).
